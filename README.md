...
TD-based value learning relies on fixed-step backups, which often fail to capture the complex temporal structure of long-horizon, multi-stage tasks. *VAST* overcomes this limitation by coupling value optimization with
